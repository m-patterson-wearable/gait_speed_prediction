...
# epochs=[20,40,80]
# layers=[
#     [[256,300,128, 64],['relu','relu','relu','relu'],[0,0,0,0]],
#     [[256,300,128, 64],['relu','relu','relu','relu'],[0.2,0.5,0.5,0]],
#     ]
# loss=['mean_squared_error']
# metrics=[['mean_squared_error']]
...
epochs=[40,80,120]
layers=[
    [[256,128, 64],['relu','relu','relu'],[0.5,0.5,0.5]],
    [[256,300,128, 64],['relu','relu','relu','relu'],[0.2,0.5,0.5,0]],
    ]
loss=['mean_squared_error']
metrics=[['mean_squared_error']]
